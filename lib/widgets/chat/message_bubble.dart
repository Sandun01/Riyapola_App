...
class MessageBubble extends StatelessWidget {
  MessageBubble(this.message, this.userId, this.userImage, this.username,
      this.isSameUser);
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
                          ...
                          if (snapshot.connectionState ==
                            ...
                            return Text("${data['name']}",
                                style: TextStyle(
                                  ...
                                  fontSize: 12.0,
                                  color:
                                      isSameUser ? Colors.black : Colors.white,
                                ));
                          }
        ...
        Positioned(
          top: 0,
          left: isSameUser ? null : 120,
          right: isSameUser ? 120 : null,
          child: CircleAvatar(
